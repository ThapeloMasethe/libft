...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/05/21 10:59:16 by tmasethe          #+#    #+#              #
#    Updated: 2018/06/06 15:20:49 by tmasethe         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME	=	libft.a
CC		= 	gcc
CFLAG	=	-Wall -Wextra -Werror -I. -c
SRC		=	ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c  ft_memmove.c ft_memchr.c ft_memcmp.c\
			...
			ft_putchar.c ft_putstr.c ft_putendl.c ft_putnbr.c ft_putnbr_fd.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c\
			ft_itoa.c ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c
